...
def game():
    ...
    # efine a variable that will start be initiated as True

    game_running = True

    # the main while-loop where the game will take place
    while game_running:
        for i in players:
            # Generate the board
            ...
            print(f"position: {current_player_position}")
